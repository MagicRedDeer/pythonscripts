# Example of how to do some fun scribbling annotations on a Viewer frame using Qt/PySide
# Right click in the Viewer and choose Frame Scribble.
# Usage:
# Copy file to: ~/.hiero/Python/StartupUI
# Right click in the Viewer and choose Frame Scribble, scribble away and save out as an image.
...
class ScribbleArea(QWidget):
        ...
        def __init__(self, parent=None):
                ...
                self.image = hiero.core.executeInMainThreadWithResult(self.getFullScreenSnapshot)
                self.originalImage = self.image
                self.lastPoint = QPoint()

        def refreshUIStep(self):
        ...
        def clearImage(self):
                self.image = self.getFullScreenSnapshot()
                self.update()
...
class FrameScribbleAction(QAction):
    ...
    class FrameScribbleDialog(QMainWindow):
            ...
            def createMenus(self):
                self.saveAsMenu = QMenu("&Save Frame As...", self)
            ...
            def saveFile(self, fileFormat):
                    ...
                    fileName,_ = QFileDialog.getSaveFileName(None, "Save Frame As...", dir=initialPath)
                    if fileName:
    ...
    def __init__(self):
            QAction.__init__(self, "Frame Scribble", None)
            self.triggered.connect(self.doit)
            self.setIcon(QIcon("icons:TabMetadata.png"))
