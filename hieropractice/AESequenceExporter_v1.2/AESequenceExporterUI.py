...
class AESequenceUI(hiero.ui.TaskUIBase):
    ...
    def populateUI(self, widget, exportTemplate):
        if exportTemplate:
                ...
                if (hiero.core.env['VersionMinor'] <= 6) :
                        ...
                        uiProperty = hiero.ui.FnUIProperty.UIPropertyFactory.create(type(value), key=key, value=value, dictionary=self._preset._properties, label=label+":", tooltip=label)
