...
def findResourcePath():
    ...
    resourcesPath = r'D:\shared\AMS2\production\EP004\SEQUENCES\SQ001\SHOTS\SQ001_SH001\animatic'
...
def createClip():
    ...
    # create the clip now
    source = MediaSource(os.path.join(resourcesPath,
        "EP004_SQ001_SH001_animatic.####.jpg"))
    clip = Clip(source)
...
clip.addToNukeScript(nukeScriptWriter, firstFrame=0)
