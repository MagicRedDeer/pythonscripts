...
base, form = loadUiType(os.path.join(__dir__, "Tutorial06.ui"))
...
propBase, propForm = loadUiType(
        os.path.join(__dir__, "Tutorial06_Properties.ui"))
nodeBase, nodeForm = loadUiType(
        os.path.join(__dir__, "Tutorial06_NodeProperties.ui"))
lightBase, lightForm = loadUiType(
        os.path.join(__dir__, "Tutorial06_LightProperties.ui"))
cameraBase, cameraForm = loadUiType(
        os.path.join(__dir__, "Tutorial06_CameraProperties.ui"))
transformBase, transformForm = loadUiType(
        os.path.join(__dir__, "Tutorial06_TransformProperties.ui"))
