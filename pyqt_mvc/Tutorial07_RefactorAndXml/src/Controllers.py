...
class WndTutorial06(base, form):
    ...
    def __init__(self, parent=None):
        ...
        self.listView.setModel(self._proxyModel)
        ...
        QtCore.QObject.connect(self.uiTree.selectionModel(), QtCore.SIGNAL("currentChanged(QModelIndex, QModelIndex)"), self.updateModel)
    ...
    def updateModel(self, current, old):
        self.listView.hide()
        self.listView.deleteLater()
        self.listView = QtGui.QListView(self)
        current = self._proxyModel.mapToSource(current)
        self.listView.setModel(SceneGraphModel(current.internalPointer()))
        self.layoutMain.addWidget(self.listView)
